...
### 5. Evaluation
  ...
  | 📏 **Metric** | 🌲 **RandomForest** | ⚡ **Optimized RF** | 🧠 **CNN** | 🔧 **CNN Denoised** | 🎯 **CNN Detection** | 🚀 **Fast R-CNN** |
  |:-------------|:-------------------:|:------------------:|:-----------:|:-------------------:|:--------------------:|:------------------:|
  | ⏱️ **Training (s)** | **`1.0274`** 🥇 | `1.2119` | `246.598` | `214.166` | `366.778` | `2802.62` 🥉 |
  | 🎯 **Accuracy** | **`0.9825`** 🥇 | `0.9775` | `0.965` | `0.9525` | `0.7754` 🥉 | `0.9048` |
  | 📊 **MSE** | **`0.075`** 🥇 | `0.1025` | `0.215` | `0.3025` 🥉 | `0.0029` | `0.004` |
  | 📈 **MAE** | `0.035` | `0.0352` | `0.0456` | `0.0568` 🥉 | **`0.009`** 🥇 | `0.0479` |
  | 🔍 **Precision/IoU** | **`0.9829`** 🥇 | `0.9783` | `0.9654` | `0.9552` | `0.1725` 🥉 | `0.2393` |
  | 📋 **R²** | `0.9286` | `0.9024` | `0.7953` | `0.712` | `0.9565` | **`0.996`** 🥇 |
