...
### 5. Evaluation
  ...
  |:-------------|:-------------------:|:------------------:|:-----------:|:-------------------:|:--------------------:|:------------------:|
  | ⏱️ **Training (s)** | **`1.0`** 🥇 | `1.2` | `247` | `214` | `367` | `2803` 🥉 |
  | 🎯 **Accuracy** | **`0.98`** 🥇 | `0.98` | `0.97` | `0.95` | `0.78` 🥉 | `0.90` |
  | 📊 **MSE** | **`0.08`** 🥇 | `0.10` | `0.22` | `0.30` 🥉 | `0.003` | `0.004` |
  | 📈 **MAE** | `0.035` | `0.035` | `0.046` | `0.057` 🥉 | **`0.009`** 🥇 | `0.048` |
  | 🔍 **Precision/IoU** | **`0.98`** 🥇 | `0.98` | `0.97` | `0.96` | `0.17` 🥉 | `0.24` |
  | 📋 **R²** | `0.93` | `0.90` | `0.80` | `0.71` 🥉 | `0.96` | **`1.00`** 🥇 |
